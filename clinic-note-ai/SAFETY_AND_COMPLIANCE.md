# ClinicNote AI — Safety and Compliance

## Core Safety Rules (MVP)

These rules are non-negotiable and apply to all versions of ClinicNote AI.
...
- ClinicNote AI is an educational and productivity documentation assistant.
...
```
This note was generated by ClinicNote AI from doctor-entered content.
It is an educational and productivity documentation tool.
It is not a medical device and does not provide clinical recommendations.
The treating doctor is solely responsible for reviewing, editing,
and approving all documentation before use.
Do not enter patient names, IDs, or contact information.
```

### Future AI Scribe Research

If ClinicNote AI evolves toward an AI scribe research project, it will require:
...
Use of ClinicNote AI in a clinical setting must:
